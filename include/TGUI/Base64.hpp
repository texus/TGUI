...
namespace tgui
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    [[nodiscard]] TGUI_API std::string base64Encode(const std::uint8_t* data, std::size_t nrBytes);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    [[nodiscard]] TGUI_API std::vector<std::uint8_t> base64Decode(CharStringView data);
} // namespace tgui
