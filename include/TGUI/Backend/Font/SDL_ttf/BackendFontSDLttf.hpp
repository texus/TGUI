...
namespace tgui
{
    ...
    public:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual bool loadFromMemory(const void* data, std::size_t sizeInBytes) override;
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        TGUI_DEPRECATED("loadInternalFont should no longer be accessed!") TTF_Font* loadInternalFont(unsigned int characterSize) const;
#endif
...
#ifndef TGUI_REMOVE_DEPRECATED_CODE
    using BackendFontSDL TGUI_DEPRECATED("BackendFontSDL was renamed to BackendFontSDLttf") = BackendFontSDLttf;
#endif
}
