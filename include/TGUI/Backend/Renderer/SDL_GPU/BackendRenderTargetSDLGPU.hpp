...
namespace tgui
{
    ...
    public:
        ...
        {
            TGUI_ASSERT(false,
                        "The SDL_GPU backend requires that you pass SDL_GPUCommandBuffer and "
                        "SDL_GPURenderPass pointers to the draw function");
            throw Exception(
                "The SDL_GPU backend requires that you pass SDL_GPUCommandBuffer and "
                "SDL_GPURenderPass pointers to the draw function");
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        bool prepareDrawGui(const std::shared_ptr<RootContainer>& root,
