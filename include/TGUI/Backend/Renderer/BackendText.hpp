...
namespace tgui
{
    ...
    protected:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        void addGlyphQuad(std::vector<Vertex>& vertices, Vector2f position, const Vertex::Color& color, const FontGlyph& glyph, float italicShear, float outlineThickness);
    ...
    protected:
        ...
        String m_string;
        unsigned int m_characterSize = 32; /// TODO: Default value = global text size?  (Keep 32 now for backwards compatibility)
        Color m_fillColor;
