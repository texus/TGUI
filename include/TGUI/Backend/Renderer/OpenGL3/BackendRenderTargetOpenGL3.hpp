...
namespace tgui
{
    ...
    public:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual void drawGui(const std::shared_ptr<RootContainer>& root);
    ...
    using BackendRenderTargetSDL TGUI_DEPRECATED("BackendRenderTargetSDL was renamed to BackendRenderTargetOpenGL3") = BackendRenderTargetOpenGL3;
#endif
}
