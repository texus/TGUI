...
TGUI_IGNORE_DEPRECATED_WARNINGS_START
    ...
    public:
        ...
        using BackendRenderTarget::setView;
#endif
    ...
    protected:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        TGUI_DEPRECATED("Pass the texture or nullptr to convertRenderStates") sf::RenderStates convertRenderStates(const RenderStates& states);
#endif
    ...
    protected:
        ...
        Color m_clearColor;
#else
        Color m_clearColor = {240, 240, 240};
#endif
