...
namespace tgui
{
    ...
    public:
        ...
        ///
        /// @warning True might still be returned for some events even when the event was ignored (e.g. a text event
        ///          is marked as handled when a widget has focus, even if the leaf widget does nothing with it).
        ...
        ///
        /// By default true will be returned for almost all key press events for backwards compatibility.
        /// Call setKeyboardNavigationEnabled(true) to enable the new behavior and cause the return value to depend
        /// on whether the key was actually handled. Note that this is only about key press events, not text events.
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
