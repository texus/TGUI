...
namespace tgui
{
    ...
    public:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        TGUI_DEPRECATED("Use Gui::convertEvent instead. This function doesn't handle touch events on desktop platforms.")
    ...
    private:
        ...
        std::map<Cursor::Type, SDL_Cursor*> m_mouseCursors;  /// We can't use unordered_map with enum class in GCC < 6
    };
