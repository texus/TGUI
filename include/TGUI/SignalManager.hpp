...
namespace tgui {
    ...
    public:
        ...
        typedef struct{std::string m_widgetName; std::string m_signalName; std::pair<Delegate, DelegateEx> m_func;} SignalTuple;
        typedef struct{SignalID m_signalId; Weak m_widget; unsigned int m_signalWidgetID;} ConnectedSignalTuple;
