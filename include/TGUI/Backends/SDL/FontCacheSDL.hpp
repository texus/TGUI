...
namespace tgui
{
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    TGUI_DEPRECATED("The FontCacheSDL class is no longer used!") class TGUI_API FontCacheSDL
    {
    public:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        static void removeFont(const BackendFontSDLttf* fontId);
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        static void registerFontSize(const BackendFontSDLttf* fontId, unsigned int characterSize);
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        static void unregisterFontSize(const BackendFontSDLttf* fontId, unsigned int characterSize);
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        static TTF_Font* getFont(const BackendFontSDLttf* fontId, unsigned int characterSize);
