...
TGUI_MODULE_EXPORT namespace tgui
{
    ...
    class TGUI_API ListView : public Widget
    {
      public:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        TGUI_NODISCARD ListViewRenderer* getSharedRenderer();
        TGUI_NODISCARD const ListViewRenderer* getSharedRenderer() const;
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        TGUI_NODISCARD ListViewRenderer* getRenderer();
    ...
    protected:
        ...
        // If true then pixelOffset is set to the distance between the center of the border and the mouse position.
        // If false then columnIndex and pixelOffset remain unchanged.
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        TGUI_NODISCARD bool findBorderBelowMouse(Vector2f pos, std::size_t& columnIndex, float& pixelOffset) const;
    ...
    protected:
        ...
        float m_resizingColumnPixelOffset = 0;
