...
namespace tgui
{
    ...
    public:
        ...
        /// @see create
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        explicit EditBoxSlider(const char* typeName = StaticWidgetType, bool initRenderer = true);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static EditBoxSlider::Ptr create(
            float min = 0.0f,
            float max = 10.0f,
            float value = 0.0f,
        ...
        /// @return The new edit box slider
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static EditBoxSlider::Ptr copy(const EditBoxSlider::ConstPtr& editBoxSlider);

        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Returns the renderer of edit box part of widget
        /// @return Temporary pointer to the renderer that may be shared with other widgets using the same renderer
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] EditBoxRenderer* getEditBoxSharedRenderer();
        [[nodiscard]] const EditBoxRenderer* getEditBoxSharedRenderer() const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] EditBoxRenderer* getEditBoxRenderer();

        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Returns the renderer of slider part of widget
        /// @return Temporary pointer to the renderer that may be shared with other widgets using the same renderer
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] SliderRenderer* getSliderSharedRenderer();
        [[nodiscard]] const SliderRenderer* getSliderSharedRenderer() const;
        ...
        /// @warning After calling this function, the widget has its own copy of the renderer and it will no longer be shared.
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] SliderRenderer* getSliderRenderer();
