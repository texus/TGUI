...
namespace tgui
{
    ...
    public:
        ...
        /// @see create
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        explicit ClickableWidget(const char* typeName = StaticWidgetType, bool initRenderer = true);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static ClickableWidget::Ptr create(const Layout2d& size = {"100%", "100%"});
        ...
        /// @return The new clickable widget
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static ClickableWidget::Ptr copy(const ClickableWidget::ConstPtr& widget);
    ...
    public:
        SignalVector2f onMousePress = {
            "MousePressed"}; //!< The mouse went down on the widget. Optional parameter: mouse position relative to widget
