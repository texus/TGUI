...
namespace tgui
{
    ...
    public:
        ...
        /// @see create
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        explicit Panel(const char* typeName = StaticWidgetType, bool initRenderer = true);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static Panel::Ptr create(const Layout2d& size = {"100%", "100%"});
        ...
        /// @return The new panel
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static Panel::Ptr copy(const Panel::ConstPtr& panel);

        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Returns the renderer, which gives access to functions that determine how the widget is displayed
        /// @return Temporary pointer to the renderer that may be shared with other widgets using the same renderer
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] PanelRenderer* getSharedRenderer() override;
        [[nodiscard]] const PanelRenderer* getSharedRenderer() const override;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] PanelRenderer* getRenderer() override;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Changes whether event bubbling is used for the mouse events
        ///
        /// @param useEventBubbling  Should event bubbling be used when processing mouse events?
        ///
        /// When event bubbling is used, no click signals will be triggered in the panel when the mouse is on a child widget.
        /// When disabled, the click event first triggers in the panel before being passed to the child widget.
        ///
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Returns whether event bubbling is used for the mouse events
        ///
        /// @return Is event bubbling used when processing mouse events?
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static bool getEventBubbling();
    ...
    public:
        SignalVector2f onMousePress = {
            "MousePressed"}; //!< The mouse went down on the panel. Optional parameter: mouse position relative to panel
