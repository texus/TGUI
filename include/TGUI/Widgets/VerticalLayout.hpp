...
namespace tgui
{
    ...
    public:
        ...
        static constexpr char StaticWidgetType[] = "VerticalLayout"; //!< Type name of the widget
        ...
        /// @see create
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        explicit VerticalLayout(const char* typeName = StaticWidgetType, bool initRenderer = true);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static VerticalLayout::Ptr create(const Layout2d& size = {"100%", "100%"});
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        [[nodiscard]] static VerticalLayout::Ptr copy(const VerticalLayout::ConstPtr& layout);
