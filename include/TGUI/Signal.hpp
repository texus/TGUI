...
namespace tgui
{
    ...
    public:
        ...
        Signal(std::string&& name, std::size_t extraParameters = 0) :
            m_name(std::move(name)) // Did not compile in VS2013 when using braces
        {
    ...
    public:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        SignalWrapper(SignalWrapper&& other) : // Did not compile in VS2013 when using '= default'
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        SignalWrapper& operator=(SignalWrapper&& other) // Did not compile in VS2013 when using '= default'
        {
            if (this != &other)
                m_signal = std::move(other.m_signal);
