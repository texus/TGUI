...
namespace tgui
{
    ...
    void ButtonBase::setIgnoreKeyEvents(bool ignore)
    {
        m_ignoreKeyEvents = ignore;
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    bool ButtonBase::getIgnoreKeyEvents() const
    {
        return m_ignoreKeyEvents;
    }
    ...
    void ButtonBase::rendererChanged(const String& property)
    {
        ...
        else if (property == U"RoundedBorderRadius")
        {
            ...
            priv::dev::setOptionalPropertyValue(text.color,
                                                getSharedRenderer()->getTextColorDownHover(),
                                                priv::dev::ComponentState::ActiveHover);
        else if (property == U"TextColorDisabled")
            priv::dev::setOptionalPropertyValue(text.color,
                                                getSharedRenderer()->getTextColorDisabled(),
            ...
            priv::dev::setOptionalPropertyValue(text.style,
                                                getSharedRenderer()->getTextStyleDownHover(),
                                                priv::dev::ComponentState::ActiveHover);
        else if (property == U"TextStyleDisabled")
            priv::dev::setOptionalPropertyValue(text.style,
                                                getSharedRenderer()->getTextStyleDisabled(),
                                                priv::dev::ComponentState::Disabled);
            ...
            priv::dev::setOptionalPropertyValue(background.texture,
                                                getSharedRenderer()->getTextureDown(),
                                                priv::dev::ComponentState::Active);
        else if (property == U"TextureHover")
            priv::dev::setOptionalPropertyValue(background.texture,
                                                getSharedRenderer()->getTextureHover(),
            ...
            priv::dev::setOptionalPropertyValue(background.texture,
                                                getSharedRenderer()->getTextureFocused(),
            ...
            priv::dev::setOptionalPropertyValue(background.color,
                                                getSharedRenderer()->getBackgroundColor(),
                                                priv::dev::ComponentState::Normal);
