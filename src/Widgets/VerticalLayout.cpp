...
namespace tgui
{
    ...
    constexpr char VerticalLayout::StaticWidgetType[];
#endif
    ...
    void VerticalLayout::updateWidgets()
    {
        ...
        const Vector2f contentSize = {getSize().x - m_paddingCached.getLeftPlusRight(), getSize().y - m_paddingCached.getTopPlusBottom()};
