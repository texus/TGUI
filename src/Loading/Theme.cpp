...
namespace tgui
{
        ...
        struct DefaultTheme : public Theme
        {
            DefaultTheme()
            {
                m_renderers = {
                    ...
                    {"Button",
                     RendererData::create(
                         {{"Borders", Borders{1}},
                          ...
                          {"BackgroundColorDisabled", Color{230, 230, 230}}})},
                    {"ChatBox",
                     RendererData::create({{"Borders", Borders{1}},
                                           {"Padding", Padding{0}},
                    ...
                    {"ContextMenu",
                     RendererData::create({{"TextColor", Color{60, 60, 60}},
                    ...
                    {"Knob",
                     RendererData::create({{"Borders", Borders{2}},
                                           {"ImageRotation", 0.f},
                                           {"BorderColor", Color::Black},
                                           {"ThumbColor", Color::Black},
                                           {"BackgroundColor", Color::White}})},
                    {"Label",
                     RendererData::create({{"Borders", Borders{}},
                                           {"BorderColor", Color{60, 60, 60}},
                                           {"TextColor", Color{60, 60, 60}},
                    ...
                    {"Panel", RendererData::create({{"BorderColor", Color::Black}, {"BackgroundColor", Color::White}})},
                    {"PanelListBox",
                     RendererData::create({{"Borders", Borders{1}},
                                           {"BorderColor", Color::Black},
                                           {"BackgroundColor", Color::White},
                    ...
                    {"ScrollablePanel", RendererData::create({{"BorderColor", Color::Black}, {"BackgroundColor", Color::White}})},
                    {"Scrollbar",
                     RendererData::create({{"TrackColor", Color{245, 245, 245}},
                    ...
                    {"SplitContainer", RendererData::create({{"SplitterColor", Color{60, 60, 60}}, {"SplitterColorHover", Color::Black}})},
    ...
    std::map<String, std::map<String, String>> Theme::m_rendererDefaultSubwidgets = {
        ...
        {"FileDialog",
         {{"Button", ""}, {"EditBox", ""}, {"ListView", ""}, {"FilenameLabel", "Label"}, {"FileTypeComboBox", "ComboBox"}}},
        {"Label", {{"Scrollbar", ""}}},
        {"ListBox", {{"Scrollbar", ""}}},
        {"ListView", {{"Scrollbar", ""}}},
        {"MessageBox", {{"Button", ""}}},
