...
namespace tgui
{
    ...
    String Layout::toString() const
    {
            ...
            || (m_operation == Operation::BindingInnerWidth) || (m_operation == Operation::BindingInnerHeight))
        {
            ...
            TGUI_ASSERT(m_operation == Operation::BindingInnerHeight,
                        "Operation can't be anything other than BindingInnerHeight here");
    ...
    Layout operator*(Layout left, Layout right)
    {
        return Layout{Layout::Operation::Multiplies,
                      std::make_unique<Layout>(std::move(left)),
                      std::make_unique<Layout>(std::move(right))};
    }
