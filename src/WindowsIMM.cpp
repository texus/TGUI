...
namespace tgui
{
    ...
    void WindowsIMM::initialize()
    {
        ...
        #pragma GCC diagnostic ignored "-Wcast-function-type"
            ...
            m_dllImmReleaseContext = reinterpret_cast<ImmReleaseContextFunc>(
                GetProcAddress(m_dllImmModuleHandle, "ImmReleaseContext"));
    #if defined(__clang__)
    ...
    {
        TGUI_ASSERT(m_referenceCount > 0,
                    "WindowsIMM::release can't be called without a corresponding WindowsIMM::initialize() call!");
        --m_referenceCount;
