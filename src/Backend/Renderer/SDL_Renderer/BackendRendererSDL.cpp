...
namespace tgui
{
    ...
    void BackendRendererSDL::setActiveRenderer(SDL_Renderer* renderer)
    {
        TGUI_ASSERT(m_renderer, "renderer passed to BackendRendererSDL::setActiveRenderer can't be a nullptr");
        m_renderer = renderer;
    }
