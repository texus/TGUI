...
namespace tgui
{
    ...
    bool BackendTexture::loadTextureOnly(Vector2u size, const std::uint8_t* pixels, bool smooth)
    {
        TGUI_ASSERT(pixels && (size.x > 0) && (size.y > 0), "load and loadTextureOnly functions in BackendTexture needs valid parameters");
