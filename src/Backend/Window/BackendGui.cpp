...
namespace tgui
{
    ...
    BackendGui::~BackendGui()
    {
        ...
        // is still being triggered that attempts to access the gui (and its container).
    ...
    {
        m_viewport = {RelativeValue(viewport.left),
                      RelativeValue(viewport.top),
                      RelativeValue(viewport.width),
                      RelativeValue(viewport.height)};
        updateContainerSize();
    }
    ...
    Vector2i BackendGui::getLastMousePosition() const
    {
