...
namespace tgui
{
    ...
    TGUI_RENDERER_PROPERTY_COLOR(RadioButtonRenderer, TextColor, sf::Color::Black)
    ...
    TGUI_RENDERER_PROPERTY_COLOR(RadioButtonRenderer, BorderColor, sf::Color::Black)
    ...
    TGUI_RENDERER_PROPERTY_COLOR(RadioButtonRenderer, CheckColor, sf::Color::Black)
