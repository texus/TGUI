...
namespace tgui
{
    ...
    GuiContainer::GuiContainer(const GuiContainer& copy) :
        Container(copy),
        m_Window (copy.m_Window)
    {
        m_Focused = copy.Focused;
    }

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    GuiContainer& GuiContainer::operator= (const GuiContainer& right)
    {
        if (this != &right)
        {
