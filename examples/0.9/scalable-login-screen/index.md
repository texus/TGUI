...
This code shows a simple login screen that scales with the window when the window is resized.  
[![Scalable login screen output](/resources/examples/0.9/ScalableLoginScreen.jpg){:width="400" height="324"}](/resources/examples/0.9/ScalableLoginScreen.jpg)
