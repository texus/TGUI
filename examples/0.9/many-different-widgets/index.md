---
layout: page
title: "Example: Many different widgets"
breadcrumb: "many different widgets"
---

This example was written to demonstrate most widgets, but many new widgets and features have been added since this example was created. Widget and text sizes are also not very consistent in this example.  
[![Scalable login screen output](/resources/examples/0.9/ManyDifferentWidgets.jpg){:width="800" height="624"}](/resources/examples/0.9/ManyDifferentWidgets.jpg)
