...
#   find_package(TGUI 0.6 ...) // version 0.6
#
...
if(SFML_STATIC_LIBRARIES)
    set(FIND_TGUI_LIB_SUFFIX "${FIND_TGUI_LIB_SUFFIX}-s")
endif()
...
if(TGUI_FIND_VERSION AND TGUI_INCLUDE_DIR)
    ...
    STRING(REGEX MATCH ".*#define TGUI_VERSION_MAJOR ([0-9]+).*#define TGUI_VERSION_MINOR ([0-9]+).*" TGUI_CONFIG_HPP_CONTENTS "${TGUI_CONFIG_HPP_CONTENTS}")
    ...
    math(EXPR TGUI_REQUESTED_VERSION "${TGUI_FIND_VERSION_MAJOR} * 10 + ${TGUI_FIND_VERSION_MINOR}")

    # transform version numbers to an integer
    math(EXPR TGUI_VERSION "${TGUI_VERSION_MAJOR} * 10 + ${TGUI_VERSION_MINOR}")
...
mark_as_advanced(TGUI_LIBRARY TGUI_LIBRARY_RELEASE TGUI_LIBRARY_DEBUG)

# handle errors
if(NOT TGUI_VERSION_OK)
    # TGUI version not ok
    set(FIND_TGUI_ERROR "TGUI found in ${TGUI_INCLUDE_DIR} but version was wrong (requested: ${TGUI_FIND_VERSION}, found: ${TGUI_VERSION_MAJOR}.${TGUI_VERSION_MINOR})")
    set(TGUI_FOUND FALSE)
...
# handle success
if(TGUI_FOUND)
    message(STATUS "Found TGUI ${TGUI_VERSION_MAJOR}.${TGUI_VERSION_MINOR} in ${TGUI_INCLUDE_DIR}")
endif()
