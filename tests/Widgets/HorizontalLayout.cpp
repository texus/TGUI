...
TEST_CASE("[HorizontalLayout]")
{
    ...
    SECTION("Positions and sizes")
    {
        ...
        SECTION("Spaces and ratios")
        {
            ...
            REQUIRE(layout->get(1)->getPosition()
                    == tgui::Vector2f(layout->get(0)->getPosition().x + layout->get(0)->getFullSize().x + 30, 0));
            REQUIRE(layout->get(2)->getPosition()
                    == tgui::Vector2f(layout->get(1)->getPosition().x + layout->get(1)->getFullSize().x + 30, 0));
            REQUIRE(layout->get(3)->getPosition()
                    == tgui::Vector2f(layout->get(2)->getPosition().x + layout->get(2)->getFullSize().x + 30, 0));
            ...
            REQUIRE(layout->get(3)->getPosition()
                    == tgui::Vector2f(layout->get(2)->getPosition().x + layout->get(2)->getFullSize().x + 30, 0));
            REQUIRE(layout->get(4)->getPosition()
                    == tgui::Vector2f(layout->get(3)->getPosition().x + layout->get(3)->getFullSize().x + 30, 0));
        }
    }
