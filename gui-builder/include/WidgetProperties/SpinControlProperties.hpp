...
struct SpinControlProperties : public WidgetProperties
{
    ...
    [[nodiscard]] PropertyValueMapPair initProperties(const tgui::Widget::Ptr& widget) const override
    {
        ...
        pair.second["SpinButton.BorderBetweenArrows"] = {"Float",
                                                         tgui::Serializer::serialize(buttonRenderer->getBorderBetweenArrows())};
        pair.second["SpinButton.ButtonsBackgroundColor"] = {"Color", tgui::Serializer::serialize(buttonRenderer->getBackgroundColor())};
        pair.second["SpinButton.ButtonsBackgroundColorHover"] =
            {"Color", tgui::Serializer::serialize(buttonRenderer->getBackgroundColorHover())};
        ...
        pair.second["SpinButton.TextureArrowUpHover"] = {"Texture",
                                                         tgui::Serializer::serialize(buttonRenderer->getTextureArrowUpHover())};
        ...
        pair.second["SpinText.SelectedTextBackgroundColor"] =
            {"Color", tgui::Serializer::serialize(textRenderer->getSelectedTextBackgroundColor())};
        ...
        pair.second["SpinText.BackgroundColorDisabled"] = {"Color",
                                                           tgui::Serializer::serialize(textRenderer->getBackgroundColorDisabled())};
        pair.second["SpinText.BackgroundColorFocused"] = {"Color",
                                                          tgui::Serializer::serialize(textRenderer->getBackgroundColorFocused())};
